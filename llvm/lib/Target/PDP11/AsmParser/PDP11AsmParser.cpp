//===-- PDP11AsmParser.cpp - Parse PDP11 assembly to MCInst instructions --===//
//
...
class PDP11AsmParser : public MCTargetAsmParser {
...
#include "PDP11GenAsmMatcher.inc"

public:
  PDP11AsmParser(const MCSubtargetInfo &STI, MCAsmParser &Parser,
...
struct PDP11Operand : public MCParsedAsmOperand {
  ...
  explicit PDP11Operand(KindTy Kind) : Kind(Kind) {}
...
bool PDP11AsmParser::parseRegister(MCRegister &RegNum, SMLoc &StartLoc,
                                   SMLoc &EndLoc) {
  return MatchRegisterName(Lexer.getTok().getIdentifier()) == PDP11::R0;
}

ParseStatus PDP11AsmParser::tryParseRegister(MCRegister &RegNum,
                                             SMLoc &StartLoc, SMLoc &EndLoc) {
  return MatchOperand_Success;
}

bool PDP11AsmParser::parseInstruction(ParseInstructionInfo & /*Info*/,
                                      StringRef Name, SMLoc NameLoc,
                                      OperandVector &Operands) {
  return false;
}

bool PDP11AsmParser::ParseDirective(AsmToken DirectiveID) { return false; }

bool PDP11AsmParser::matchAndEmitInstruction(SMLoc IDLoc, unsigned &Opcode,
                                             OperandVector &Operands,
                                             MCStreamer &Out,
                                             uint64_t &ErrorInfo,
...
extern "C" LLVM_EXTERNAL_VISIBILITY void LLVMInitializePDP11AsmParser() {
  RegisterMCAsmParser<PDP11AsmParser> x(getThePDP11Target());
}
